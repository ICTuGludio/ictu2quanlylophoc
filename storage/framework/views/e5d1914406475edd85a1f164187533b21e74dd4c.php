<?php if($lop): ?>
	<?php $__env->startSection('title'); ?>
		Dánh sách sinh viên trong lớp <?php echo e($lop->tenlop); ?> 
...
<?php $__env->startSection('content'); ?>
   ...
   <div class="main-content" style="padding-top:20px">
	<div class="row">
		...
		<div class="widget">
			<div class="widget-title"><h3><div class="text-bold text-uppercase text-center">Danh sách sinh viên lớp <?php echo e($lop->tenlop); ?></div></h3></div>
		<div class="widget-body">
